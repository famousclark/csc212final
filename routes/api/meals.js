...
router.get('/get', ctrlMeal.getMeal); /* Returns a restaurant matching the given meal id. JSON body payload format :: {"meal_id":"someString"}*/
router.post('/add', ctrlMeal.saveMeal); /* Adds a new meal. JSON body payload format :: {"meal_id":"someString", "name":"someString", "description":"someString", "r_code":"someString", "dinning_hall_item":"someString" , "allergens":[Array of Strings], "diet_restrinctions":[Array of Strings], "serve_amount":"a number", "nutrition":{Object (see model)}, "image":"someString", "price":"someString"}*/
...
router.post('/delete', ctrlMeal.deleteMeal); /* Deletes a meal matching the given meal id. JSON body payload format :: {"meal_id":"someString"}*/
