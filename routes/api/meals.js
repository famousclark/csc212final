...
router.get('/get/byRestaurant', ctrlMeal.getMealsByRestaurants); /* Returns a restaurant matching the given a restaurant code. JSON body payload format :: {"r_code":"number between 1000-9999"}*/
